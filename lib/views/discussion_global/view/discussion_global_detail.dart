...
import 'package:kampus_gratis/views/discussion_global/components/content_discussion_global_detail.dart';
...
class DiscussionGlobalDetailView extends GetView<DiscussionDetailController> {
  const DiscussionGlobalDetailView({Key? key}) : super(key: key);
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  if (index == 0) {
                    return ContentDiscussionGlobalDetail(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                if (controller.isReply.isTrue) {
                                  await controller.postReplyCommentDf(
                                    controller.idComment.value,
                                    controller.commentController.text,
                                    Get.arguments[0],
                                  );
                                } else {
                                  await controller.postCommentDf(
                                    Get.arguments[0],
                                    controller.commentController.text,
                                  );
                                }
                              ...
                              child: Center(
                                child: Text(
                                  'Kirim',
                                  style: Themes.darkTheme.textTheme.button!
                                      .copyWith(
                                    fontSize: 14,
